document.addEventListener('DOMContentLoaded', () => {
    ...
    const outOfStockCategory = document.getElementById('out-of-stock-category');
    ...
    outOfStockCategory.addEventListener('change', (event) => {
        loadOutOfStockItems(event.target.value);
    });
